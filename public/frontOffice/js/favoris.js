    ...
    try {
        ...
        if (data.success) {
            if (data.action === 'added') {
                ...
                if (window.location.pathname.includes('mes-favoris') ||
                    window.location.pathname.includes('favoris')) {
                    ...
                    const remaining = document.querySelectorAll('.favorite-btn[data-logement-id]').length;
                    if (remaining === 0) {
                        location.reload();
                    }
                }
