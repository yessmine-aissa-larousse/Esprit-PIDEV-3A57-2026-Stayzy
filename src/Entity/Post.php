...
class Post
{
    ...
    // DB: varchar(1000) nullable
    #[ORM\Column(length: 1000, nullable: true)]
    private ?string $hashtags = null;

    // DB: tinyint(1) NOT NULL (no default) — default false in PHP
    ...
    public function setHashtags(?string $hashtags): static { $this->hashtags = $hashtags; return $this; }
